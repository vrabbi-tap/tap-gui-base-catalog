...
For more information on the labels automatically set by Application Live View Convention, see [Convention server](convention-server.hbs.md).
...
Read about the [Application Live View Convention](convention-server.hbs.md) and the [Spring Boot Convention](https://docs.vmware.com/en/Tanzu-Application-Platform/1.1/tap/GUID-spring-boot-conventions-about.html) to understand the potential impact of this, and manually configure this to suit your security needs.
